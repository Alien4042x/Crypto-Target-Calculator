...
"}")
        ...
        self.stop_loss_box.returnPressed.connect(lambda: self.Calculating())
...
"}")
        ...
        self.take_profit_box.returnPressed.connect(lambda: self.Calculating())
...
"}")
        ...
        self.entry_line_box.returnPressed.connect(lambda: self.Calculating())
        self.label_6 = QtWidgets.QLabel(self.centralwidget)
        self.label_6.setGeometry(QtCore.QRect(10, 200, 146, 16))
